...
function blogmagazine_body_classes_old( $classes ) {
    ...
    $archive_sidebar        = get_theme_mod( 'blogmagazine_archive_sidebar', 'right_sidebar' );
    $post_default_sidebar   = get_theme_mod( 'blogmagazine_default_post_sidebar', 'right_sidebar' );        
    $page_default_sidebar   = get_theme_mod( 'blogmagazine_default_page_sidebar', 'right_sidebar' );
...
function blogmagazine_get_sidebar_name() {
    ...
    if(is_archive()){
        $sidebar_name = get_theme_mod( 'blogmagazine_archive_sidebar', $default_sidebar );
    }
    if(is_search()){
        $sidebar_name = get_theme_mod( 'blogmagazine_search_sidebar', $default_sidebar );
    }
    if(is_page()){
        $page_sidebar_name = get_theme_mod( 'blogmagazine_default_page_sidebar', $default_sidebar );
    ...
    if(is_single()){
        $single_sidebar_name = get_theme_mod( 'blogmagazine_default_post_sidebar', $default_sidebar );
        $metabox_sidebar_details = get_post_meta( get_the_ID(), 'dglib_single_post_sidebar', true );
        $metabox_sidebar_name = (isset($metabox_sidebar_details['sidebar_layout'])) ? esc_attr($metabox_sidebar_details['sidebar_layout']) : '';
...
if( ! function_exists( 'blogmagazine_archive_read_more_button' ) ) :

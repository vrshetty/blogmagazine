...
if( ! function_exists( 'blogmagazine_dynamic_styles' ) ) :
    ...
    function blogmagazine_dynamic_styles() {
        ...
        foreach( $get_categories as $category ){
            ...
            $cat_color = get_theme_mod( 'dglib_category_color_'.strtolower( $category->slug ), '#00a9e0' );
        ...
        $output_css .= "a,a:hover,a:focus,a:active,.widget a:hover,.widget a:hover::before,.widget li:hover::before,.entry-footer a:hover,.comment-author .fn .url:hover,#cancel-comment-reply-link,#cancel-comment-reply-link:before,.logged-in-as a,.blogmagazine-slide-content-wrap .post-title a:hover,#top-footer .widget a:hover,#top-footer .widget a:hover:before,#top-footer .widget li:hover:before,.blogmagazine_featured_posts .blogmagazine-single-post .blogmagazine-post-content .blogmagazine-post-title a:hover,.blogmagazine_fullwidth_posts .blogmagazine-single-post .blogmagazine-post-title a:hover,.blogmagazine_block_posts .layout3 .blogmagazine-primary-block-wrap .blogmagazine-single-post .blogmagazine-post-title a:hover,.blogmagazine_featured_posts .layout2 .blogmagazine-single-post-wrap .blogmagazine-post-content .blogmagazine-post-title a:hover,.blogmagazine-related-title,.blogmagazine-post-meta span:hover,.blogmagazine-post-meta span a:hover,.blogmagazine_featured_posts .layout2 .blogmagazine-single-post-wrap .blogmagazine-post-content .blogmagazine-post-meta span:hover,.blogmagazine_featured_posts .layout2 .blogmagazine-single-post-wrap .blogmagazine-post-content .blogmagazine-post-meta span a:hover,.blogmagazine-post-title.small-size a:hover,#footer-navigation ul li a:hover,.entry-title a:hover,.entry-meta span a:hover,.entry-meta span:hover,.blogmagazine-post-meta span:hover, .blogmagazine-post-meta span a:hover, .blogmagazine_featured_posts .blogmagazine-single-post-wrap .blogmagazine-post-content .blogmagazine-post-meta span:hover, .blogmagazine_featured_posts .blogmagazine-single-post-wrap .blogmagazine-post-content .blogmagazine-post-meta span a:hover,.blogmagazine_featured_slider .featured-posts .blogmagazine-single-post .blogmagazine-post-content .blogmagazine-post-title a:hover, .blogmagazine-block-title .wdgt-tab-term { color: ". esc_attr( $blogmagazine_theme_color ) ."}\n";
        ...
        $output_css .= "@media (max-width: 768px) { .main-navigation,.main-small-navigation li.current-menu-item > .sub-toggle i { background-color: ". esc_attr( $blogmagazine_theme_color ) ." !important } }\n";

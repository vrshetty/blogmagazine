...
<p class="dg-widget-field-wrapper sub-option widget-upload <?php echo esc_attr($dg_widget_field_wraper); ?>">
	...
	<!-- .img-preview-wrap -->
	<input type="text" class="widefat <?php echo esc_attr($dg_widget_relation_class); ?>" name="<?php echo esc_attr( $centurywidget->get_field_name( $dg_widget_field_name ) ); ?>" id="<?php echo esc_attr( $centurywidget->get_field_id( $dg_widget_field_name ) ); ?>" placeholder="<?php esc_html_e('Choose file', 'blogmagazine'); ?>" value="<?php echo esc_url( $dg_widget_field_value ); ?>" data-relations="<?php echo esc_attr($dg_widget_relation_json) ?>" />

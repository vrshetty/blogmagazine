...
<p class="dg-widget-field-wrapper <?php echo esc_attr($dg_widget_field_wraper); ?>">
	<input class="<?php echo esc_attr($dg_widget_relation_class); ?>" id="<?php echo esc_attr( $centurywidget->get_field_id( $dg_widget_field_name ) ); ?>" name="<?php echo esc_attr( $centurywidget->get_field_name( $dg_widget_field_name ) ); ?>" type="checkbox" value="1" <?php checked( '1', $dg_widget_field_value ); ?> data-relations="<?php echo esc_attr($dg_widget_relation_json) ?>"/>

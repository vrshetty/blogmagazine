...
<p class="dg-widget-field-wrapper dg-color-field-wrapper <?php echo esc_attr($dg_widget_field_wraper); ?>">
	...
	<input class="widefat dg-color-picker <?php echo esc_attr($dg_widget_relation_class); ?>" id="<?php echo esc_attr( $dglibwidget->get_field_id( $dg_widget_field_name ) ); ?>" name="<?php echo esc_attr( $dglibwidget->get_field_name( $dg_widget_field_name ) ); ?>" type="text" value="<?php echo esc_attr( $dg_widget_field_value ); ?>"  data-relations="<?php echo esc_attr($dg_widget_relation_json) ?>"/>

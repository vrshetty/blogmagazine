...
<p class="dg-widget-field-wrapper <?php echo esc_attr($dg_widget_field_wraper); ?>">
	...
	<?php foreach ( $dg_widget_field_options as $athm_option_name => $athm_option_title ) { ?>
		<label class="block-field widefat" for="<?php echo esc_attr( $centurywidget->get_field_id( $dg_widget_field_name ) ).esc_attr($athm_option_name); ?>">
			<input id="<?php echo esc_attr( $centurywidget->get_field_id( $dg_widget_field_name ) ).esc_attr($athm_option_name); ?>" name="<?php echo esc_attr( $centurywidget->get_field_name( $dg_widget_field_name ) ); ?>[]" type="checkbox" value="<?php echo esc_attr($athm_option_name); ?>" <?php checked(1, in_array($athm_option_name, $dg_widget_field_value) ); ?>/>

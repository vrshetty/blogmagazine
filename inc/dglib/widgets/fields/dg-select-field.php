...
<p class="dg-widget-field-wrapper <?php echo esc_attr($dg_widget_field_wraper); ?>">
	...
	<select name="<?php echo esc_attr( $centurywidget->get_field_name( $dg_widget_field_name ) ); ?>" id="<?php echo esc_attr( $centurywidget->get_field_id( $dg_widget_field_name ) ); ?>" class="widefat <?php echo esc_attr($dg_widget_relation_class); ?>" data-relations="<?php echo esc_attr($dg_widget_relation_json) ?>">
		<?php foreach ( $dg_widget_field_options as $athm_option_name => $athm_option_title ) { ?>
			<option value="<?php echo esc_attr( $athm_option_name ); ?>" id="<?php echo esc_attr( $centurywidget->get_field_id( $athm_option_name ) ); ?>" <?php selected( $athm_option_name, $dg_widget_field_value ); ?>>
